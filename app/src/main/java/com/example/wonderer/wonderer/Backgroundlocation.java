    ...
    private class LocationListener implements android.location.LocationListener
    {
        ...
        public void onLocationChanged(Location location)
        {
           // Toast.makeText(getApplicationContext(),String.valueOf(location.getLatitude()), Toast.LENGTH_SHORT).show();
            ...
            if(Backgroundlocation.l.size()<10000)
            {
                Backgroundlocation.l.add(location);
            }
         Main2Activity.travel.add(location);
if(count==0) {
    Toast.makeText(getApplicationContext(), "Location track is started", Toast.LENGTH_LONG).show();
count=1;}
        }
