...
import com.example.wonderer.wonderer.gamenote.Game;
...
public static int x=3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     if(x==1) {
         ...
         setContentView(R.layout.gamification_page);
            bottomNavigationView = (BottomNavigationView) findViewById(R.id.bottomNavView_Bar);
            Menu menu = bottomNavigationView.getMenu();
            bottomNavigationView.setAnimationCacheEnabled(false);

            menu.findItem(R.id.ic_center_focus).setChecked(true);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.ic_arrow:
                        Intent intent0 = new Intent(getApplicationContext(), SocialActivity.class);
                        Bottombarnav.x=1;
